<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActualizarCatalogo.aspx.cs" Inherits="ExamenUnicoEbayComputers.ActualizarCatalogo" MasterPageFile="~/MasterPageAdmin.Master" %>
    ...
    <div class="container mt-5">
        ...
        <div class="row mt-5 text-left">
            ...
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="txttipo" runat="server" required/>
            </div>
            <div class="col-md-3">
                <p>Precio</p>
                <input type="number" class="form-control" id="txtvalor" runat="server" required/>
            </div>
        </div>
        <div class="row mt-5">
            <div class="col-md-12">
                <asp:Button runat="server" ID="xD" Text="Actualizar" CssClass="btn btn-success" OnClick="xD_Click" />
            </div>
        </div>
